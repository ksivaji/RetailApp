...
package com.example.retailtestapp.utils;
 ...
 * via {@link #setSelectedIndicatorColors(int...)}. The alternative is via the {@link SlidingTabLayout.TabColorizer} interface which provides you complete control over
